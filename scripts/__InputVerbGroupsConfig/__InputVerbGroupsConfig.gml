...
function __InputVerbGroupsConfig()
{
	...
	InputVerbGroupDefine(INPUT_VERB_GROUP.MENU, [INPUT_VERB.ACCEPT, INPUT_VERB.CANCEL]);
	InputVerbGroupDefine(INPUT_VERB_GROUP.GAMEPLAY, [INPUT_VERB.JUMP, INPUT_VERB.ATTACK]);
